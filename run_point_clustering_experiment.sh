...
# 参考偏差和点聚类半径在 generation_config 的 localization 段设置。
...
EXPERIMENT_ROOT="${EXPERIMENT_ROOT:-${PROJECT_ROOT}/outputs/point_clustering_experiment_$(date -u +%Y%m%dT%H%M%S)_$$}"
